...
https://doc.qt.io/qtforpython/examples/example_opengl__contextinfo.html
"""
...
class RenderWindow(QWindow):
    ...
    def init_gl(self):
        ...
        self.vbo.allocate(sip.VoidPtr(self._vertices_data), vertices_size + colors_size)
        # self.vbo.write(vertices_size, VoidPtr(self._colors_data), colors_size)
        self.vbo.write(vertices_size, sip.VoidPtr(self._colors_data), colors_size)
        self.vbo.release()
