...
import inspect
# import qtpy
from qtpy.QtGui import QPainter, QPen, QColor, QNativeGestureEvent, QPixmap, QCursor
from qtpy.QtWidgets import QWidget, QRubberBand, QSizePolicy, QLabel, QPushButton, QGridLayout, QVBoxLayout
from qtpy.QtCore import Qt, QPointF, QRectF, QSize, QPoint
