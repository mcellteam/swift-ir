...
class UserProjects(QWidget):
    ...
    def get_data(self):
        ...
        for p in self.project_paths:
            ...
            logger.info('Getting thumbnail first...')
            ...
            logger.info('Getting thumbnail last...')
