...
class FileBrowserTacc(QWidget):
    ...
    def initUI(self):
        ...
        # self.bSetRootWork.setStyleSheet(button_gradient_style)
        ...
        # self.bSetRootScratch.setStyleSheet(button_gradient_style)
        ...
        # self.bSetRootSpecial.setStyleSheet(button_gradient_style)
