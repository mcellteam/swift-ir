...
class WebBrowser(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        # buttonBrowserViewSource.setFocusPolicy(Qt.NoFocus)
        ...
        buttonDocumentation.setFocusPolicy(Qt.NoFocus)
        ...
        # buttonWolframAlpha.setFocusPolicy(Qt.NoFocus)
        ...
        hbl.addWidget(buttonBrowserBack, alignment=Qt.AlignRight)
        hbl.addWidget(buttonBrowserForward, alignment=Qt.AlignLeft)
        hbl.addWidget(QLabel(' '))
        hbl.addWidget(buttonBrowserRefresh, alignment=Qt.AlignLeft)
        # hbl.addWidget(QLabel(' '))
        # hbl.addWidget(buttonBrowserViewSource, alignment=Qt.AlignLeft)
        hbl.addWidget(QLabel(' '))
        hbl.addWidget(buttonBrowserCopy, alignment=Qt.AlignLeft)
        hbl.addWidget(QLabel(' '))
        hbl.addWidget(buttonBrowserPaste, alignment=Qt.AlignLeft)
        hbl.addWidget(QLabel('   |   '))
        hbl.addWidget(button3demCommunity, alignment=Qt.AlignRight)

        # hbl.addWidget(buttonDocumentation, alignment=Qt.AlignRight)
        # hbl.addWidget(QLabel(' '))
        # hbl.addWidget(buttonWolframAlpha, alignment=Qt.AlignRight)
        # hbl.addWidget(QLabel(' '))
        # hbl.addWidget(self.urlBar, alignment=Qt.AlignCenter)
        ...
        self.layout.addWidget(browser_controls_widget, alignment=Qt.AlignLeft)
