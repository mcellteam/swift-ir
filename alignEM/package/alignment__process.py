...
# This file was previously named 'alignment__process.py'
import numpy as np
import os
import sys
import platform
...
__all__ = ['alignment_process','align_recipe','align_ingredient']
...
class alignment_process:
    ...
    def __init__(self, im_sta_fn=None, im_mov_fn=None, align_dir='./', layer_dict=None, init_affine_matrix=None,
        ...
        print('========================================================' +
              ...
              '\nscript       : ' + print(sys.argv[0]) + '\nrunning in   :' +
              os.path.dirname(os.path.realpath(__file__)) + '\nsys.pathc    : ' + sys.path +
              '\nmodule names : ' + str(modulenames) + '\nallmodules   : ' + str(allmodules) +
              '\nIn module products sys.path[0] = ' + sys.path[0] + '\n__package__ = ' +
              __package__ + '\n========================================================')
