...
# -*- coding: utf-8 -*-
#
# alignem_tutorial documentation build configuration file, created by
...
# General information about the datamodel.
project = 'AlignEM'
copyright = ('2020, MMBioS, Salk Institute for Biological Studies, '
             'Pittsburgh Supercomputing Center')

# The version info for the datamodel you're documenting, acts as replacement for
...
# "<datamodel> v<release> documentation".
...
htmlhelp_basename = 'alignem_tutorialdoc'
...
latex_documents = [
  ('index', 'alignem_tutorial.tex', 'AlignEm Tutorial',
   'SWiFT-IR Team', 'manual'),
]
...
man_pages = [
    ('index', 'alignem_tutorial', 'alignem_tutorial Documentation',
     ['SWiFT-IR Team'], 1)
]
...
texinfo_documents = [
  ('index', 'alignem_tutorial', 'alignem_tutorial Documentation',
   'SWiFT-IR Team', 'alignem_tutorial', 'Tutorial on using AlignEm.',
   'Miscellaneous'),
]
