...
def generate_scales(progress_callback=None):
    ...
    n_images = em.getNumImportedImages()
    n_scales = em.getNumScales()
...
#0709    # scaling_queue = task_queue.TaskQueue(n_tasks=n_images, progress_callback=progress_callback)
    ...
    print("generate_scales | # cpus        :", cpus)
    print("generate_scales | my_path       :", my_path)
    print("generate_scales | my_system     :", my_system)
    print("generate_scales | my_node       :", my_node)
    print('generate_scales | Starting the scaling queue...')
    ...
    if my_system == 'Darwin':
        ...
        iscale2_c = '/Users/joelyancey/glanceem_swift/swift-ir/source/c/bin_darwin/iscale2'
                            ...
                            if scale == 1:
                                if em.get_best_path(abs_file_name) != em.get_best_path(outfile_name):
                                    ...
                                    try:
                                        ...
                                        print("generate_scales | Unable to link from " + abs_file_name + " to " + outfile_name)
                                        print("generate_scales | Copying file instead")
                                        ...
                                        try:
                                            ...
                                            print("generate_scales | Unable to link or copy from " + abs_file_name + " to " + outfile_name)
                            else:
                                try:
                                    # Do the scaling
                                    # print(
