...
def print_command_line_syntax ( args ):
  ...
  print_debug ( -1, '  Apply 2D python_swiftir matrix to input image file' )
  ...
  print_debug ( -1, '  -afm 1 0 0 0 1 0    : the 2D python_swiftir matrix' )
...
if (__name__ == '__main__'):
  ...
  print('image_apply_affine | main | in_fn = sys.argv[-2] <-- ', in_fn)
  print('image_apply_affine | main | out_fn = sys.argv[-1] <-- ', out_fn)
