...
def worker(worker_id, task_q, result_q, n_tasks, n_workers, pbar_q = None):
    ...
    for task_id, task in  iter(task_q.get, 'END_TASKS'):
        ...
        # print('task =\n', task)
        '''THIS IS THE FUNCTION CALL IN image_apply_affine.py (main):
...
class TaskQueue:
    ...
    def start(self, n_workers, retries=1) -> None:
        ...
        # self.progress_callback.emit(95) # <-- this works
        self.task_dict = {}
        self.task_id = 0
...
task= ['/Users/joelyancey/.local/share/virtualenvs/swift-ir-AuCIf4YN/bin/python3', 
       '/Users/joelyancey/glanceem_swift/swift-ir/source/Qt/package/image_apply_affine.py', 
       '-gray', 
       '-afm', 
       '1.040024184796598', 
       '-0.06164416771039566', 
...
INFO:interface:   ARGS:   ['/Users/joelyancey/glanceem_swift/swift-ir/source/Qt/package/single_alignment_job.py', '/Users/joelyancey/glanceEM_SWiFT/test_projects/full_volume_josef_2/project_runner_job_file.json', 'init_affine', '4', 'c', '127', '1', '1']
INFO:interface:   STDERR: /Users/joelyancey/.local/share/virtualenvs/swift-ir-AuCIf4YN/bin/python3: can't open file '/Users/joelyancey/glanceem_swift/swift-ir/source/Qt/package/single_alignment_job.py': [Errno 2] No such file or directory
...
project_runner.do_alignment | Starting task_queue_mp with args:
  ...
  /Users/joelyancey/Downloads/swift-ir-joel-dev-pyside6/source/Qt/package/single_alignment_job.py
