...
Notes:
    * script depends on alignem_utils.py functions for scale pyramid functionality. keep files in the same directory.
        * daisy
...
if __name__ == '__main__':
    ...
    ap.add_argument('-n', '--dataset_name', default='img_aligned_zarr', type=str,
                    help="Destination dir (default: 'img_aligned_zarr')")
    ap.add_argument('-s', '--scale_ratio', default='1,2,2', type=str,
                    help="Scaling ratio for each axis (default: '1,2,2')")
