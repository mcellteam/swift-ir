...
def print_debug_enter(level):
    if level <= debug_level:
        ...
        sys.stderr.write("pyswift_tui.print_debug_enter | Call Stack: " + str([stack_item.function for stack_item in call_stack][1:]) + '\n')
...
def save_bias_analysis(al_stack, bias_data_path):
    print('pyswift_tui.save_bias_analysis >>>>>>>>')
...
#     print('pyswift_tui.run_json_project >>>>>>>>')
#     print("pyswift_tui.run_json_project | alignment_option = ", alignment_option)
#     print("pyswift_tui.run_json_project | use_scale = ", use_scale)
#     print("pyswift_tui.run_json_project | swiftir_code_mode = ", swiftir_code_mode)
#     print("pyswift_tui.run_json_project | alone = ", str(alone))
#     print_debug_enter(40)
...
#
#     print_debug(20, "pyswift_tui.run_json_project | first_layer_has_ref = " + str(first_layer_has_ref))
#     print_debug(20, "pyswift_tui.run_json_project | ref = \"" + str(project['data']['scales']['scale_%d' % use_scale]['alignment_stack'][0]['images']['ref']['filename']) + "\"")
#
#     print_debug(10, 80 * "!")
#     align_swiftir.global_swiftir_mode = swiftir_code_mode
#     print('pyswift_tui.run_json_project | align_swiftir.global_swiftir_mode = ', align_swiftir.global_swiftir_mode)
#
...
#         print_debug(-1, 'pyswift_tui.run_json_project | AlignEM SWiFT Error: Cannot perform alignment_option: %s at scale: %d' % (
#         alignment_option, scale_tbd))
#         print_debug(-1, 'pyswift_tui.run_json_project |                        Because next coarsest scale is not fully aligned')
#
#         return (project, False)
#
#     if scale_tbd:
#         if use_scale:
#             print_debug(5,"pyswift_tui.run_json_project | Performing alignment_option: %s  at user specified scale: %d" % (alignment_option, scale_tbd))
#             print_debug(5, "pyswift_tui.run_json_project | Finest scale completed: ", finest_scale_done)
#             print_debug(5, "pyswift_tui.run_json_project | Next coarsest scale completed: ", next_scale)
#             print_debug(5, "pyswift_tui.run_json_project | Upscale factor: ", upscale)
#         else:
#             print_debug(5, "pyswift_tui.run_json_project | Performing alignment_option: %s  at automatically determined scale: %d" % (
#             alignment_option, scale_tbd))
#             print_debug(5, "pyswift_tui.run_json_project | Finest scale completed: ", finest_scale_done)
#             print_debug(5, "pyswift_tui.run_json_project | Next coarsest scale completed: ", next_scale)
#             print_debug(5, "pyswift_tui.run_json_project | Upscale factor: ", upscale)
...
#         print_debug(10, 80 * "@")
#         print_debug(10, "pyswift_tui.run_json_project | Range limited to: " + str(range_to_process))
#         print_debug(10, 80 * "@")
#
...
#             print_debug(50, '\npyswift_tui.run_json_project | >>>>>>> Original affine matrices: \n\n')
#             print_debug(50, str(afm_tmp))
#             afm_scaled = afm_tmp.copy()
#             afm_scaled[:, :, 2] = afm_scaled[:, :, 2] * upscale
#             print_debug(50, '\npyswift_tui.run_json_project | >>>>>>> Scaled affine matrices: \n\n')
...
#
#         print_debug(10, 80 * "#")
#         print_debug(10, "pyswift_tui.run_json_project | Before aligning, align_list: " + str(align_list))
#         print_debug(10, 80 * "#")
#
...
#             print_debug(10, 80 * "@")
#             print_debug(10, "pyswift_tui.run_json_project | Not starting at zero, initialize the c_afm to non-identity from previous aligned image")
#             print_debug(10, 80 * "@")
...
#         if (range_to_process[0] != 0) and not alone:
#             print_debug(10, 80 * "@")
#             print_debug(10, "pyswift_tui.run_json_project | Initialize to non-zero biases")
#             print_debug(10, 80 * "@")
#
...
#             if item['do']:
#                 align_item = item['proc']
#                 print_debug(4, '\npyswift_tui.run_json_project | Aligning: %s %s' % (
...
#             else:
#                 align_item = item['proc']
#                 print_debug(50, '\npyswift_tui.run_json_project | Not Aligning: %s %s' % (
#                 os.path.basename(align_item.im_sta_fn), os.path.basename(align_item.im_mov_fn)))
#
#         '''
#         c_afm_init = swiftir.identityAffine()
...
#
#         print_debug(1, 30 * "|=|")
#         print_debug(1, "pyswift_tui.run_json_project | Returning True")
#         print_debug(1, 30 * "|=|")
#
...
#
#         print_debug(1, 30 * "|=|")
#         print_debug(1, "pyswift_tui.run_json_project | Returning False")
#         print_debug(1, 30 * "|=|")
#
#         print('<<<<<<<< pyswift_tui.run_json_project')
#         return (project, False)
...
if (__name__ == '__main__'):
    ...
    if (len(sys.argv[1:]) < 3):
        print_command_line_syntax(sys.argv[1:])
        exit(1)
    ...
    while i < len(sys.argv) - 2:
        ...
        if sys.argv[i] == '-master':
            ...
            print("\nImproper argument list: " + str(sys.argv[1:]) + "\n")
            print_command_line_syntax(sys.argv[1:])
            exit(1)
