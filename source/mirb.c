    ...
    if (text_lines[i][0] == 'F') {
      ...
      if (text_lines[i][0] == 'W') {
        ...
        */
        ...
        if (num_averaged > 0) {
          fprintf ( stdout, "/nadata/cnl/home/bobkuczewski/proj/Reconstruct/test_image_sets/DA5/DA5_1200b.jpg AF  1.0 0.0 %lf 0.0 1.0 %lf\n", -avg_y, -avg_x );
          fprintf ( stdout, "/nadata/cnl/home/bobkuczewski/proj/Reconstruct/test_image_sets/DA5/DA5_1200b.jpg AI  1.0 0.0 %lf 0.0 1.0 %lf\n",  avg_y,  avg_x );
        }
