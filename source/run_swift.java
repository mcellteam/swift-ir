...
class global_io {
  ...
  public static boolean is_windows() {
	if ( !is_windows_set ) {
		is_windows_true = System.getProperty("os.name").strip().toLowerCase().startsWith("win");
		is_windows_set = true;
	}
...
public class run_swift {
  ...
  public static void copy_file_by_name ( Runtime rt, String original_file_name, String new_file_name, int output_level ) {
    ...
    try {
      ...
      command_line = mir_cmd + " zeroth.mir";
  ...
  public static void transform_file_by_name ( Runtime rt, String original_file_name, String new_file_name, double affine_transform[], int output_level ) {
    ...
    try {
      ...
      command_line = mir_cmd + " pairwise.mir";
  ...
  public static String[] align_files_by_name ( Runtime rt, String fixed_image_file, String align_image_file, String aligned_image_file,
    ...
    try {
      ...
      command_line = swim_cmd + " " + window_size;
...
if (use_line_parts) {
      ...
      command_line = mir_cmd + " first.mir";
...
if (use_line_parts) {
      ...
      command_line = mir_cmd + " second.mir";
...
if (use_line_parts) {
      ...
      command_line = mir_cmd + " third.mir";
  ...
  public static void main(String[] args) throws java.io.FileNotFoundException {
	...
	System.out.println ( "System: " + System.getProperty("os.name").strip().toLowerCase().startsWith("win") );
	if ( System.getProperty("os.name").strip().toLowerCase().startsWith("win") ) {
